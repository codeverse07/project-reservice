        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-6">
          ...
          <div className="px-6 pb-6 relative">
            <div className="flex flex-col md:flex-row items-center md:items-end -mt-12 mb-4 gap-4">
               ...
               <button className="px-4 py-2 rounded-xl bg-gray-100 text-gray-700 font-medium text-sm hover:bg-gray-200 transition-colors">
                 Edit Profile
               </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                ...
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <span className="text-gray-600 text-sm truncate">{user.address}</span>
                </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            {menuItems.map((item, index) => (
                <Link 
                    key={index} 
                    to={item.path}
                    className="flex items-center justify-between p-4 hover:bg-gray-50 transition-colors border-b last:border-b-0 border-gray-50"
                >
            ...
            <button className="w-full flex items-center gap-4 p-4 hover:bg-red-50 transition-colors text-red-600 group mt-2 border-t border-gray-100">
